...
export default class TabNavigator extends React.Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      pan               : new Animated.ValueXY({x:0, y:-35})
    };
  ...
  render() {
    ...
    var AnimatedPlayer = this.props.animatedPlayerView,
        animatedStyle  = {
          position : 'absolute',
          // bottom   : 0,
          bottom   : this.state.pan.y.interpolate({
            inputRange: [
    ...
    return (
      <View {...props} style={[styles.container, style]}>
        {scenes}
        <AnimatedPlayer pan={this.state.pan}/>
        <TabBar style={[tabBarStyle, animatedStyle]}
